...
component = {
	...
	template : `
			    <md-sidenav class="md-sidenav-right md-whiteframe-4dp" md-component-id="addEmployee">
			      <md-toolbar class="md-theme-light">
			        <h1 class="md-toolbar-tools">New Employee</h1>
			      </md-toolbar>
				...
				<form name="employeeForm" >
			      <md-input-container class="md-block">
				      ...
				      <div>
				        <md-button type="submit" ng-click="$ctrl.addEmployee($ctrl.Employee)">SAVE</md-button>
...
angular.module('adpApp.employee.add',[])
.component('employeeAdd', component)
